# Mock JSON OpenAPI Specification
...
6. If you did everything correct, https://pixelmord.github.io/api-demo--mock-json-server-api-docs/ will lead to your new docs
